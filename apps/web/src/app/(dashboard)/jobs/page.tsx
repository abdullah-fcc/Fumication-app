...
import { Plus, Search, Briefcase } from '@/components/icons';
...
export default function JobsPage() {
  ...
  return (
    <div>
      <PageHeader
        title="Jobs"
        subtitle="Schedule and manage fumigation tasks"
        actions={
          <Link href="/jobs/new">
            <Button size="sm">
              <Plus size={15} />
              ...
              <tr>
                <td colSpan={5} className="p-0">
                  <EmptyState
                    ...
                    title="No jobs found"
                    subtitle={search || statusFilter ? 'Try adjusting your filters' : 'Create your first job to get started'}
                    action={
                      !search && !statusFilter ? (
                        <Link href="/jobs/new">
